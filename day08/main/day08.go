...
func main() {
	fmt.Println("Advent of Code 2017 - day 08")
	...
	name, value := registerWithLargestValue(bank)

	fmt.Printf("Solution 1: register with largest value: %q = %v\n", name, value)

	bank = instruction.NewRegisterBank()

	name, value = registerWithLargestValueDuringEvaluation(instructions, bank)

	fmt.Printf("Solution 2: largest value at any time: %q = %v\n", name, value)
}
