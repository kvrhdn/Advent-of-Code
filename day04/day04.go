...
func main() {
	fmt.Println("Advent of Code 2017 - day 04")

	fmt.Println("solution 1 =", countValidPassphrases(input, NoDuplicates))
	fmt.Println("solution 2 =", countValidPassphrases(input, NoAnagrams))
}
